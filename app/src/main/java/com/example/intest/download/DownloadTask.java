package com.example.intest.download;
...
public class DownloadTask {
    ...
    public DownloadTask(Context context, String downloadUrl,String name) {
        ...
        downloadFileName = name+".pdf";//Create file name by picking download file name from URL
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setTitle("CV  ");
                    alertDialogBuilder.setMessage("The Cv Downloaded Successfully !");
                    ...
                    alertDialogBuilder.setNegativeButton("Open Cv",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
